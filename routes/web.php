...
Route::prefix("admin")->middleware('admin')->group(function () {
    ...
    Route::prefix('mailinfo')->group(function () {
        ...
        Route::get('show-message', [SendmailController::class, 'showMessage'])->name('mailinfo.show-message');
        Route::get('create-category', [SendmailController::class, 'createCategory'])->name('mailinfo.create-category');
        Route::get('get-category', [SendmailController::class, 'getCategory'])->name('mailinfo.get-category');
        Route::post('update-category', [SendmailController::class, 'updateCategory'])->name('mailinfo.update-category');
        Route::post('store-category', [SendmailController::class, 'storeCategory'])->name('mailinfo.store-category');
        Route::post('delete-category', [SendmailController::class, 'deleteCategory'])->name('mailinfo.delete-category');
    });
});
